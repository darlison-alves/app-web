...
import AccountPendingIcon from 'mdi-react/CubeSendIcon';
          ...
          <Drawer menu={this.menu}>
            <main ref={this.mainContent} className={classes.content}>
              <Switch>
                ...
                <PermissionRoute path='/list-orders' role={enRoles.sysAdmin} component={OrderIndexPage} />
